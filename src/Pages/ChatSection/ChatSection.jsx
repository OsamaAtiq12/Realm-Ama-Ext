...
import GptTypeDropDown from "../../Components/GptTypeDropDown/GptTypeDropDown";
...
function ChatSection() {
  const [selectedQuestion, setSelectedQuestion] = useState(""); // State to track selected question
  ...
  return (
    <div className="px-8 py-5 bg-white rounded-lg">
      ...
      <div className="border-2 rounded-[16px] p-5 mt-9 min-h-[426px]">
              ...
              <div className="mt-[20px]">
                {presetQuestions.map((question, index) => (
                  <div
                    ...
                    className="max-w-[250px] text-[12px] font-normal p-[12px] rounded-[8px] mb-4 cursor-pointer"
      ...
      <div className="flex items-center p-2 bg-white relative   mt-[20px]">
        ...
        <Input
          ...
          onChange={(e) => setInputValue(e.target.value)} // Handle input field change
        />
